...
def build_prompt(a):
    ...
    return (
        ...
        "emojis sobrios y saltos de linea). Estructura EXACTA:\n"
        "- 1a linea: VEREDICTO en MAYUSCULAS (ej. 'SWING BAJISTA, REBOTE INTRADIA FINO') con un "
        "emoji verde/amarillo/rojo coherente con el semaforo.\n"
